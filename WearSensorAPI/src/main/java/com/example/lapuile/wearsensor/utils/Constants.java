...
public class Constants {
    ...
    public static final String ENDPOINT_REPOSITORY_BASE_URL = KAA_EPTS_API_BASE_URL+"applications/"+KAA_APPLICATION_NAME+"/time-series/data";
    public static final String APPLICATION_REPOSITORY_BASE_URL = KAA_EPTS_API_BASE_URL + "time-series/config";
}
