...
/**
 * Utility class to collect the constant values among the project
 */
public class Constants {
	public static final SimpleDateFormat KAA_EPTS_API_DATE_FORMAT = com.example.lapuile.wearsensor.library.utils.Constants.KAA_EPTS_API_DATE_FORMAT;
