...
public class KaaEndpointsConfigurationsFormatter {
	 ...
	 * @param encodedJSON JSON to be converted in the List of KaaEndpointConfigurations
	 * @return List of KaaEndpointConfigurations
	 * @throws UnsupportedEncodingException Might throw an error if the JSON wasn't encoded with the method "URLEncoder.encode"
	 */
	 ...
	 * @param kaaEndpointConfigurations List of KaaEndpointConfigurations to be converted in a JSON
	 * @return JSON of serialized KaaEndpointConfigurations
	 * @throws UnsupportedEncodingException If the JSON generated by the class KaaEndpointConfiguration is not well formed
	 */
